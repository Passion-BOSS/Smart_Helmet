...
#define CONFIG_ENABLE_DRIVER_SAMPLE 1
#define CONFIG_DRIVER_SAMPLE_BUTTON 1
#define CONFIG_ROLL_UP_PIN 0
#define CONFIG_ROLL_DOWN_PIN 1
#define CONFIG_PUSH_BUTTON_PIN 2
#define CONFIG_DRIVER_SAMPLE_LED_PWM 1
#define CONFIG_LED_PWM_PIN 4
#define CONFIG_DRIVER_SAMPLE_SERIAL1 1
#define CONFIG_ENABLE_MAIN_SAMPLE 1
#define CONFIG_SAMPLE_MAIN_TASK1_LED 1
#define CONFIG_SAMPLE_MAIN_TASK2_GASSENSOR 1
#define CONFIG_SAMPLE_MAIN_TASK3_HALLSENSOR 1
#define CONFIG_ENABLE_LOGIC_SAMPLE 1
#define CONFIG_SAMPLE_LOGIC_GASSENSOR 1
#define CONFIG_SAMPLE_LOGIC_FLASHLIGHT 1
#define CONFIG_FLASHLIGHT_ENABLE 1
#define CONFIG_FLASHLIGHT_DEFAULT_BRIGHTNESS 50
#define CONFIG_FLASHLIGHT_STORAGE_SUPPORT 1
#define CONFIG_SAMPLE_LOGIC_HALLSENSOR 1
